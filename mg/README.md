...
при внимательном рассмотрении видим, что мг различает три значения
0 1 2-200
смна свопинес с 2 до 200 не показывает влияния на результат
смена на 1 дает небольшое влияние, процентов на 5-10

для мг проведено по 15 тестов со значениями 1 2 10 100
...
# 83.3+79.4+82.2+79.5+80.3+83.9+100.8+81.7+83.4+98.7+86.7+86.3+98.1+85.0+87.4
# = 1296.7
```
...
# 82.1+96.2+78.6+80.6+81.4+87.8+101.2+86.0+85.5+86.6+85.8+98.0+87.0+85.6+87.2
# = 1309.6
```
...
# 79.9+77.4+81.9+82.9+78.8+85.7+85.2+85.4+86.8+99.0+84.9+100.9+86.1+82.4+82.7
# = 1280.0
```
...
# 81.7+80.8+81.7+80.3+93.3+79.3+87.8+86.2+87.7+89.1+85.9+85.5+99.8+85.4+86.3
# 1290.8
```
...
# 97.7+88.5+95.1+96.4+92.5+98.0+97.7+102.1+92.8+97.7+105.2+99.9+98.5+94.9+95.6
# = 1452.6
```
